...
params = {"learningRate": 0.0001, "weightDecay": 0.001, "epochs": 20, "batchSize": 64, "optimizer": "adam", "validationStep": 100}
...
functions.trainLoop(dataTrain, dataVal,  model, loss, True, modelName, params, False, device)
